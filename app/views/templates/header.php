...
<body style="background-color: #DADBBD;">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
    <div class="container">
      <a class="navbar-brand" href="<?= BASEURL; ?>">SIDOS</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link" href="<?= BASEURL; ?>/mk">Mata Kuliah</a>
          <a class="nav-item nav-link" href="<?= BASEURL; ?>/pilihan">Mata Kuliah Mahasiswa</a>
        </div>
      </div>
    </div>
  </nav>